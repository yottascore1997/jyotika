const statusStyles: Record<string, string> = {
  ...
  Sample: "bg-fuchsia-50 text-fuchsia-700 ring-fuchsia-600/20",
  Repair: "bg-orange-50 text-orange-700 ring-orange-600/20",
  "Repaired – Awaiting Dispatch": "bg-lime-50 text-lime-700 ring-lime-600/20",
  "DOA (Dead on Arrival)": "bg-rose-50 text-rose-700 ring-rose-600/20",
  ...
  "Under Service": "bg-orange-50 text-orange-700 ring-orange-600/20",
  "With Customer": "bg-blue-50 text-blue-700 ring-blue-600/20",
